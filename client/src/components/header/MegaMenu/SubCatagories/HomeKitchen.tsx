interface SubcategoriesProps {
  ...
  const HomeKitchen: React.FC<SubcategoriesProps> = ({ isVisible }) => {
    ...
    return (
      ...
      >
        <div className="absolute top-0 left-[250px] w-[500px] h-[404px] bg-white border border-r-0 border-gray-300 shadow-lg p-[15px] grid grid-cols-2 gap-3 text-xs bg-center bg-cover bg-no-repeat bg-[url('https://demo-morata.myshopify.com/cdn/shop/files/bg_menu2_500x.png?v=1698914115')]">
