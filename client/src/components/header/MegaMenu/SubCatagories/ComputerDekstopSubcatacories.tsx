...
const ComputerDesktopSubcategories: React.FC<SubcategoriesProps> = ({ isVisible }) => {
      ...
      >
        ...
        <div className="absolute top-0 left-[750px] w-[225px] bg-white border-r-1 border-t-1 border-b-1 p-[14px] grid grid-cols-2 gap-3 text-xs">
          <div className="w-[199px]">
            <img
              src="https://demo-morata.myshopify.com/cdn/shop/files/menu_1.png?v=1698913220&width=2000"
              className="w-[300px]"
...
export default ComputerDesktopSubcategories;
