...
const FeaturedProducts = () => {
  ...
  const mainProducts = [
    {
      ...
      reviews: 4,
      price: 49.00,
      image: "https://demo-morata.myshopify.com/cdn/shop/products/products_2_1.jpg?v=1697644616&width=533",
      hoverImage: "https://demo-morata.myshopify.com/cdn/shop/products/products_2_2.jpg?v=1697644616&width=533",
      features: [
  ...
  const otherProducts = [
    ...
    },
    {
      ...
      rating: 5,
      price: "49.00",
      image: "https://demo-morata.myshopify.com/cdn/shop/products/products_30_1.jpg?v=1697644834&width=533",
      hoverImage: "https://demo-morata.myshopify.com/cdn/shop/products/products_30_2.jpg?v=1697644834&width=533",
    },
    {
      id: 7,
      ...
      rating: 5,
      price: "150.00",
      image: "https://demo-morata.myshopify.com/cdn/shop/products/products_34_1.jpg?v=1697644904&width=533",
      hoverImage: "https://demo-morata.myshopify.com/cdn/shop/products/products_34_2.jpg?v=1697644904&width=533"
    },
    {
      id: 8,
      ...
      oldPrice: "128.00",
      discount: "-22%",
      image: "https://demo-morata.myshopify.com/cdn/shop/products/products_32_1.jpg?v=1697644893&width=533",
      hoverImage: "https://demo-morata.myshopify.com/cdn/shop/products/products_32_2.jpg?v=1697644893&width=533"
    },
    {
      id: 8,
      ...
      oldPrice: "128.00",
      discount: "-22%",
      image: "https://demo-morata.myshopify.com/cdn/shop/products/products_22_1.jpg?v=1697644765&width=533",
      hoverImage: "https://demo-morata.myshopify.com/cdn/shop/products/products_22_2.jpg?v=1697644766&width=533"
    }
  ];

  const nextSlide = () => {
    setCurrentSlide((prev) => (prev === mainProducts.length - 1 ? 0 : prev + 1));
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev === 0 ? mainProducts.length - 1 : prev - 1));
  };
  ...
  return (
    <div className="max-w-[1500px] mx-auto px-4 py-8 rubik ">
      <h2 className="text-2xl font-bold mb-6 relative inline-block">
        ...
        <div className="absolute bottom-0 left-0 w-1/2 h-1 bg-blue-500"></div>
      </h2>
      ...
      <div className="flex  w-full gap-5 group/buttons ">
        ...
        <div className="w-[1300px] h-[280px] bg-white rounded-lg  px-6  relative overflow-hidden">
          ...
          <div key={product.id} className="bg-white flex  rounded-2xl sha  ">
            ...
            >
             ...
             <img
              ...
              <div className="flex items-center gap-2 text-[0.85rem]">
                <span className="text-[#CC1414] font-medium">${product.price}</span>
                {product.oldPrice && (
                  <span className="text-gray-400 font-normal line-through">${product.oldPrice}</span>
                )}
              </div>
             </div>
            </div>
